  ...
  const actions = [
    {
      ...
      dueDate: 'Today',
      studyId: 1,
      studyName: 'Cancer Research Study 2024'
    },
    {
      id: 2,
      type: 'review',
    ...
    },
    {
      ...
      dueDate: 'In 3 days',
      studyId: 2,
      studyName: 'Diabetes Management Study'
    },
    {
      id: 4,
      type: 'blocked',
    ...
    <div className="flex-1 flex flex-col bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="px-8 py-6">
          ...
          <p className="text-sm text-gray-500 mt-1">Task management & assignments - Pending and upcoming actions</p>
        </div>
      </div>
          ...
          {actions.map((action) => (
            ...
            >
              <div className="flex items-start justify-between">
                ...
                <button
                  onClick={() => navigate(`/studies/${action.studyId}`)}
                  className="ml-4 px-4 py-2 bg-orange-500 hover:bg-orange-600 text-white text-sm font-medium rounded-lg transition-colors"
                >
                  Take Action
                </button>
              </div>
          ...
          <div className="flex items-center justify-center h-96">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500">
                All tasks are completed or there are no tasks assigned to you
              </p>
            </div>
          </div>
        )}
