...
type RoleKey = 'admin' | 'project_manager' | 'study_designer' | 'build_reviewer' | 'uat_member' | 'site_manager' | 'data_manager'
...
const Header = ({ onToggleSidebar }: HeaderProps) => {
  ...
  const handleLogout = () => {
    ...
    localStorage.removeItem('authToken')  // Remove both keys for compatibility
  ...
  const getRoleLabel = (role: string | undefined): string => {
    ...
    return labels[role as RoleKey] || role || ''
  }
