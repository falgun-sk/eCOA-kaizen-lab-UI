...
import { getNavigationForRole } from '../shared/constants/navigation'
...
type IconName = 'dashboard' | 'studies' | 'tasks' | 'forms' | 'templates' | 'reviews' |
  'testing' | 'sites' | 'devices' | 'access' | 'audit' | 'translations' |
  'library' | 'settings' | 'data' | 'reports'
